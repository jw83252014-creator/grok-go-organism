  ...
  return (
    <section className="terrarium-panel rounded-md p-4">
      ...
      <div className="mb-4">
        ...
        <div className="h-3 overflow-hidden rounded-full border border-emerald-400/25 bg-black p-[2px]">
          <motion.div
      ...
      <div className="grid grid-cols-2 gap-4 border-t border-cyan-400/15 pt-4 text-sm">
        <div>
        ...
        <div className="text-right">
          ...
          <div className="mt-2 text-xs text-cyan-200">human approval required</div>
        </div>
      </div>
    </section>
  );
